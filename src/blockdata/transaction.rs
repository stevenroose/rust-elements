...
/// An Elements transaction, which describes an authenticated movement of coins.
///
...
impl Transaction {
    ...
    pub fn signature_hash(&self, input_index: usize, script_pubkey: &Script, sighash_u32: u32) -> SigHash {
        ...
        if anyone_can_pay {
            tx.input = vec![TxIn {
				...
				is_pegin: self.input[input_index].is_pegin,
				has_issuance: self.input[input_index].has_issuance,
				asset_issuance: self.input[input_index].asset_issuance,
    ...
    pub fn is_coin_base(&self) -> bool {
        self.input.len() == 1 && self.input[0].is_coin_base()
    }
}
...
mod tests {
    ...
    fn elements_transaction() {
        ...
        assert_eq!(tx.input.len(), 1);
        assert_eq!(tx.input[0].is_coin_base(), false);
        assert_eq!(tx.is_coin_base(), false);
    ...
    #[test]
    fn elements_pegout_tx_vector_1() {
        let tx: Transaction = hex_deserialize!("\
    ...
    #[test]
    fn elements_pegout_with_numeric_pak() {
        let tx: Transaction = hex_deserialize!("\
    ...
    #[test]
    fn elements_pegout_with_null_scriptpubkey() {
        let tx: Transaction = hex_deserialize!("\
            0200000000021c39a226160dd8962eb273772950f0b603c319a8e4aa9912c9e8\
            e36b5bdf71a2000000006a473044022071212fcde89d1055d5b74f17a162b3db\
            e5348ac8527a131dab5dcf8a97d67d2f02202edf12f3c69fed1fa0c23da608e6\
