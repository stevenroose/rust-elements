...
impl Params {
    ...
    pub fn calculate_root(&self) -> sha256::Midstate {
        ...
        let leaves = [
            ...
            serialize_hash(self.fedpeg_program().unwrap_or(&Script::new())).into_inner(),
...
mod tests {
    ...
    fn test_param_roots() {
        ...
        let header = ::blockdata::block::BlockHeader {
            ext: ::blockdata::block::ExtData::Dynafed {
